...
RETURN_CODE fill_config(struct tts_config *config) {
    ...
    char secret_key[] = "O7SmzOcKynFSGkoPWcSBGDkOjqZupaLl";

    // text 的内容为"欢迎使用百度语音合成"的urlencode,utf-8 编码
    // 可以百度搜索"urlencode"
    char text[] = "Graduation Design for Yang Bo's Embedded Writing and Translation of IoT in Class 1 of Optoelectronics, Grade 20, Changsha University";
